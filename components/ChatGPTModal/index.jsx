...
const ChatGPTModal = () => {
	...
	return (
		<div className={`sticky z-50 top-0 flex justify-center items-center w-screen h-screen ${!isOpen ? "hidden" : "backdrop-blur"}`}>
			<div className="bg-white-100 h-[75vh] w-[75vw] rounded-[20px] p-[20px] ">
				<div
				...
				<div className="flex flex-col gap-[20px] h-[calc(100%-120px)] overflow-y-auto">
...
const ChatGPTMessage = ({ message, sender, cardState, index }) => {
	...
	return (
		<div className={`flex flex-row gap-[10px] ${index == 0 && "pr-[40px]"}`}>
