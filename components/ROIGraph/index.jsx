...
export default function ROIGraph({ points, t = new Date().getFullYear() }) {
	...
	return (
		<div className="h-[300px] flex flex-col w-[500px] overflow-hidden bg-white-100 border border-white-300 rounded-[20px]">
			<div className="px-[20px] py-[20px] pb-[40px] flex justify-between">
				...
				<div className="bg-white-200 rounded-full flex overflow-hidden">
					<a className="button text-center flex items-center pl-[16px] py-[8px] pr-[8px]">Normal</a>
					<a className="button pl-[8px] text-center flex items-center py-[8px] pr-[16px]">CO2 Adjusted</a>
				</div>
			</div>
			<div className="points relative flex-1">
				...
				<div
					id="graphBackground"
					className="absolute w-full h-full bg-white-100"
					style={{
						clipPath: `polygon(${polygon})`,
					}}
				/>
				...
				<div
					id="maxValueLine"
					className="absolute w-full flex gap[10px] translate-y-[50%] text-white-400 items-center"
					style={{
				...
				<div
					id="targetValueLine"
					className="absolute flex gap[10px] w-full translate-y-[50%] text-white-600 items-center"
					style={{
						bottom: ((target[1] - min[1]) * 100) / verticalRange + "%",
						left: 0,
					}}
				>
					<div className="h-[2px] bg-white-600 flex-1" />
					<p className="caption px-[20px]">${target[1].toLocaleString()}</p>
					<div className="h-[2px] bg-white-600 flex-[7]" />
				</div>
				<div
					id="targetPointVerticalIntersection"
					className="absolute w-[2px] bg-white-600"
					style={{
				...
				<div
					...
					className={classNames(
						`absolute box-border bg-white-100 border-2
			...
			<div id="labels" className="border-t border-t-white-300 box-border py-[10px] flex justify-around text-white-400">
