...
export default function CostGraph({ points, t = new Date().getFullYear() }) {
    ...
    return (
        <div
            ...
            className="flex-1 flex flex-col overflow-hidden bg-white-600 rounded-[20px]"
        >
            <div className="px-[20px] py-[20px] pb-[40px]">
                <p className="caption text-white-400">Unit Cost</p>
                <div className="flex">
                    <h4 className="inline text-white-100">$</h4>
                    <CountUp number={target[1]} className="text-white-100" />
                </div>
            </div>
            <div className="points relative flex-1">
                ...
                <div
                    ...
                    className={classNames(
                        `absolute box-border bg-white-600 border border-2
