...
export default function WatchlistCard({ img, alt, name, price, trend, remove }) {
    return (
        <div className="flex items-stretch bg-white-100 border border-white-300  overflow-hidden w-max rounded-[8px]">
            ...
            <p onClick={remove} className="caption p-[10px] flex justify-content items-center bg-white-200">-</p>
        </div>
    )
}